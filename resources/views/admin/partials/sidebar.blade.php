        ...
        <ul role="list" class="flex flex-1 flex-col gap-y-7">
            ...
            <li>
                <ul role="list" class="-mx-2 space-y-1">
                    ...
                    {{-- User Management --}}
                    <li>
                        <div class="text-xs font-semibold leading-6 text-gray-400 mt-4">User Management</div>
                    </li>
                    <li>
                        <a href="{{ route('admin.users.index') }}" 
                           class="{{ request()->routeIs('admin.users.*') ? 'bg-gray-800 text-white' : 'text-gray-400 hover:text-white hover:bg-gray-800' }} group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold transition">
                            <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    ...
                    <li>
                        <a href="{{ route('admin.jobs.pending') }}" 
                           class="{{ request()->routeIs('admin.jobs.pending') ? 'bg-gray-800 text-white' : 'text-gray-400 hover:text-white hover:bg-gray-800' }} group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold transition relative">
                            ...
                            Pending Approval
                            @php
                                $pendingJobs = \App\Models\JobPosting::where('verification_status', 'pending')->count();
                            @endphp
                            @if($pendingJobs > 0)
                                <span class="ml-auto bg-yellow-500 text-white text-xs font-medium px-2 py-0.5 rounded-full">
                                    {{ $pendingJobs }}
                    ...
                    <li>
                        <a href="{{ route('admin.reports.index') }}" 
                           class="{{ request()->routeIs('admin.reports.*') ? 'bg-gray-800 text-white' : 'text-gray-400 hover:text-white hover:bg-gray-800' }} group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold transition relative">
                            ...
                            Reports
                            @php
                                $reportedCount = 0; // Add when you have reports table
                            @endphp
                            @if($reportedCount > 0)
                ...
                <ul role="list" class="-mx-2 mt-2 space-y-1">
                    <li>
                        <a href="{{ route('admin.testimonials.index') }}" 
                           class="{{ request()->routeIs('admin.testimonials.*') ? 'bg-gray-800 text-white' : 'text-gray-400 hover:text-white hover:bg-gray-800' }} group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold transition">
                            <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    ...
                    <li>
                        <a href="{{ route('admin.pages.index') }}" 
                           class="{{ request()->routeIs('admin.pages.*') ? 'bg-gray-800 text-white' : 'text-gray-400 hover:text-white hover:bg-gray-800' }} group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold transition">
                            <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                ...
                <ul role="list" class="-mx-2 mt-2 space-y-1">
                    ...
                    <li>
                        <a href="{{ route('admin.logs.index') }}" 
                           class="{{ request()->routeIs('admin.logs.*') ? 'bg-gray-800 text-white' : 'text-gray-400 hover:text-white hover:bg-gray-800' }} group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold transition">
                            <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
