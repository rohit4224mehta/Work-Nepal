...
@section('title', 'Top Companies Hiring in Nepal - WorkNepal')

@section('meta_description', 'Discover top companies hiring in Nepal. Browse company profiles, see open positions, and find your next career opportunity.')
...
<div class="bg-white dark:bg-gray-900 min-h-screen">
    ...
    <div class="bg-gradient-to-r from-red-600 to-red-700 py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                <h1 class="text-4xl font-bold text-white mb-4">Top Companies Hiring in Nepal</h1>
                <p class="text-xl text-red-100 max-w-3xl mx-auto">
                    Discover great places to work. Explore company profiles, culture, and open positions.
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12 max-w-4xl mx-auto">
                ...
                <div class="bg-white/10 backdrop-blur-lg rounded-xl p-6 text-center">
                    <div class="text-3xl font-bold text-white">{{ number_format($stats['industries_count']) }}+</div>
                    <div class="text-red-100 mt-2">Industries</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div class="flex flex-col sm:flex-row justify-between items-center">
            <p class="text-gray-600 dark:text-gray-400">
                ...
                <span class="font-semibold">{{ number_format($companies->total()) }}</span> companies
            </p>
        ...
        @if($companies->count() > 0)
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                @foreach($companies as $company)
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                        <div class="p-6">
                            {{-- Company Header --}}
                            <div class="flex items-start gap-4">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    @if($company->industry)
                                        <p class="text-sm text-gray-600 dark:text-gray-400 mb-2">{{ $company->industry }}</p>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="mt-6 flex items-center justify-between">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-sm font-medium text-gray-900 dark:text-white">
                                        {{ $company->job_postings_count }} {{ Str::plural('job', $company->job_postings_count) }} open
                                    </span>
                                </div>
    ...
    <div class="bg-gray-50 dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 mt-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <h2 class="text-3xl font-bold text-gray-900 dark:text-white text-center mb-12">Browse by Industry</h2>
            
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                @foreach($topIndustries as $industry)
                    <a href="{{ route('companies.index', ['industry' => $industry->industry]) }}" 
                       class="bg-white dark:bg-gray-700 rounded-xl p-6 text-center hover:shadow-lg transition border border-gray-200 dark:border-gray-600">
                        <div class="text-2xl font-bold text-red-600 mb-2">{{ $industry->count }}</div>
                        <div class="text-sm text-gray-900 dark:text-white font-medium">{{ $industry->industry }}</div>
    ...
    <div class="bg-gradient-to-r from-red-600 to-red-700">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div class="text-center">
                <h2 class="text-3xl font-bold text-white mb-4">Is your company hiring?</h2>
                ...
                <a href="{{ route('employer.company.create') }}" 
                   class="inline-flex items-center px-8 py-4 bg-white text-red-600 font-bold rounded-xl hover:bg-gray-100 transition-all transform hover:-translate-y-1 shadow-xl">
